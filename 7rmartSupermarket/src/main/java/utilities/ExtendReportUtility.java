...
public class ExtendReportUtility {
	...
	public synchronized static ExtentReports createExtentReports() {//mult testcases shuld not collide so synchronisastion is given
		...
		reporter.config().setReportName("7rmartSupermarket");//config().setReportName("7RMart Project") 2 methods in ExtentSparkReporter
